...
import { EventsNavigator } from './app/navigators/AddNavigator'
import { HomeNavigator } from './app/navigators/HomeNavigator'
import { InvoicesNavigator } from './app/navigators/InvoicesNavigator'
		...
		<NavigationContainer>
	  	...
	  	{usernameState === 'FOUND' && (<>
			<Tab.Navigator>
				...
				<Tab.Screen name="Connections" component={FriendsNavigator}  options={{
					headerShown: false,
					tabBarIcon: () => (<Image source={friendImage} style={{width: 20, height: 20}} />)
				}}/>
				<Tab.Screen name="Add" component={EventsNavigator}  options={{
					headerShown: false,
					tabBarIcon: () => (<Image source={eventImage} style={{width: 20, height: 20}} />)
				}}/>
				<Tab.Screen name="Invoices" component={InvoicesNavigator}  options={{
					headerShown: false,
